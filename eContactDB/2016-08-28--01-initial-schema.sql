...
create sequence s$person_seq increment 1 start 2 cache 1;
CREATE TABLE person (
...
create sequence s$person_account_seq increment 1 start 2 cache 1;
CREATE TABLE person_account (
  id_person_account bigint NOT NULL,
  version bigint NOT NULL,
...
create sequence s$visit_log_seq increment 1 start 1 cache 1;
CREATE TABLE visit_log (
  id_visit_log bigint NOT NULL,
...
create sequence s$audit_rev increment 1 start 1 cache 1;
...
create sequence s$audit_rev_changed increment 1 start 1 cache 1;
